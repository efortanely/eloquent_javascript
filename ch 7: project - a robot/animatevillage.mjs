...
import { goalOrientedRobot, VillageState } from "./07_robot.mjs";
...
class Animation {
  ...
  updateParcels() {
    ...
    for (let { place, address } of this.worldState.parcels) {
      ...
      node.style.cssText =
        "position: absolute; height: 16px; width: 16px; background-image: url(https://eloquentjavascript.net/img/parcel2x.png); background-position: 0 -" +
        offset +
        "px";
